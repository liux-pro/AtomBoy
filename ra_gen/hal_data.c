...
const lpm_cfg_t g_lpm0_cfg =
{
    ...
    .standby_wake_sources       = LPM_STANDBY_WAKE_SOURCE_IRQ5 |  (lpm_standby_wake_source_t) 0,
...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.00025 seconds. Actual duty: 1%. */ .period_counts = (uint32_t) 0x2ee0, .duty_cycle_counts = 0x78, .source_div = (timer_source_div_t)0,
    .channel             = 9,
    .p_callback          = NULL,
...
gpt_instance_ctrl_t g_timer0_1ms_fps_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer0_1ms_fps_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_timer0_1ms_fps_extend =
{
    ...
    .capture_filter_gtiocb       = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_timer0_1ms_fps_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer0_1ms_fps_cfg =
{
    ...
    .channel             = 0,
    .p_callback          = g_timer0_1ms_fps_callback,
    /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
    .p_context           = &NULL,
#endif
    .p_extend            = &g_timer0_1ms_fps_extend,
    .cycle_end_ipl       = (2),
...
/* Instance structure to use this module. */
const timer_instance_t g_timer0_1ms_fps =
{
    .p_ctrl        = &g_timer0_1ms_fps_ctrl,
    .p_cfg         = &g_timer0_1ms_fps_cfg,
    .p_api         = &g_timer_on_gpt
};
